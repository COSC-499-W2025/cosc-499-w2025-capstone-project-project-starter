...
def test_name_cleaning():
    ...
    assert ItemFormatter._clean_project_title("my-cool_project-main.zip") == "My Cool Project"
    assert ItemFormatter._clean_project_title("simple_app") == "Simple App"
...
def test_bullet_generation(sample_project_data):
    ...
    # Check for specific keywords generated by our logic
